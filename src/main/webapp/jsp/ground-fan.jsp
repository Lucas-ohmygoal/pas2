                        ...
                        <div class="form d-flex">
                            <div class="content">
                                ...
                                <div id="registerContent"
                                    ...
                                    <h5>︎<a style="color: #007bff;">↯</a>趴地扇产品信息登记</h5><br/>
                                    <table>
                                        <form method="post" action="ground-fan.jsp?userId=<%=userId%>" id="registerForm"
                                              name="registerForm">
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="form-group" style="margin-left: 20px;">
                                                        ...
                                                        <select class="custom-select" data-msg="请输入产品名称"
                                                                placeholder="趴地扇" id="productsName"
                                                                style="width: 200px;">
                                                            <option value=rf>普通趴地扇</option>
                                                            <option value=rf>摇头趴地扇</option>
                                                        </select>
                                                        <div class="invalid-feedback">
                                                            请输入产品名称
                                                        </div>
