...
<section class="layui-col-md10" style="border-radius: 0.5rem;margin-top: 85px;margin-left: 120px; float: none;">
    <div class="layui-card">
        <div class="layui-card-header" style="font-size: 16px;text-align: center;"><a style="font-size: 18px;color: #009688;" id="genre"></a>产品入库登记表</div>
    ...
    layui.use(['jquery', 'table', 'layer'], function(){
        ...
        var active = {
            ...
            save: function(){
                ...
                var productsIncreaseX1=[];

                for(var i=0;i < input.length;i++){
                    productsIncreaseX1[i] = {
                        "userId": "<%=userId%>",
                ...
                var productsIncreaseInput = {"productsIncreaseX1List":productsIncreaseX1};
                console.log(productsIncreaseInput);
                $.ajax({
                    type: "POST",
                    url: "http://localhost:8080/pas2/product/increase",
                    dataType: "json",
                    contentType: "application/json",
                    data: JSON.stringify(productsIncreaseInput),
            ...
            switch(event){
                ...
                case "stateTwo":
                    ...
                    if("<%=from%>" != "RF" && stateVal == 1){
                        ...
                        tr.find("input[name='stateTwo']").val(0);
                        stateVal = 0;
                    }
