...
<head>
    ...
    <link href="${pageContext.request.contextPath}/css/switchStyle.css" rel="stylesheet">
                ...
                <div class="row">
                        ...
                        <div class="info">
                            ...
                            <div class="content">
                                ...
                                <button style="border-radius: 0.1rem; width: 200px" class="btn btn-warning"
                                        href='yield.jsp?userId=<%=userId%>&from=<%=type%>'
                                        id="yielding">
                                    入库登记>>
                                </button>
                    ...
                    <div class="col-lg-9 bg-white">
                        <div class="form d-flex ">
                            <div class="content">
                                <img src="../img/roof-fan.jpg" id="roof"
                                     style="position: relative; height: 370px; width: 490px; top:20px;padding: 0;left: 15%;">
                                <div id="queryContent" style="display: none">
                                    <h5>︎<a style="color: #007bff;">↯</a>楼顶扇库存综合查询</h5>
                                    <br/>
                                    <table>
                                        <tr>
                                            <td>
                                                <select id="queryCondition" data-placeholder="请选择查询条件(多选)"
                                                        class="chosen-select custom-select" style="width: 450px;"
                                                        multiple tabindex="5">
                                                ...
                                                <div class="invalid-feedback"><a
                                                        style="position:absolute;font-size: 15px; top:130px;">
                                                    ✗ 查询条件还是要输入一下的吧...
                                                </a>
                                                </div>
                                            </td>
                                    ...
                                    <div id="resultHolder" style="width: 450px !important; display: none;">
                                        <table class="table" id="resultTable">
                                            <thead>
                                            <tr>
                                                <th style="text-align: center; font-size: 20px; font-family: cursive; background-color: #337ab7">
                                                    查询结果(台)
                                                </th>
                                            </tr>
                                            </thead>
                                            ...
                                            <tr id="resultRow" style="height: 60px;">
                                                <td id="result"
                                                    style="text-align: center;background-color: white;color: #ff666c; font-family: cursive; font-size: 60px;"></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                        <table>
                                            <tr>
                                                <td>
                                                    <div><a style="font-size: 17px;color: #337ab7">
                                                        >> 目前楼顶扇的库存总量为
                                                    </a><a style="font-family: cursive;font-size: 30px;"
                                                           id="allStocks"></a></div>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <div id="registerContent"
                                    ...
                                    <h5>︎<a style="color: #007bff;">↯</a>楼顶扇产品信息登记</h5><br/>
                                    <table>
                                        <form method="post" action="roof-fan.jsp?userId=<%=userId%>" id="registerFrom"
                                              name="registerForm">
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="form-group" style="margin-left: 20px;">
                                                        ...
                                                        <select class="custom-select" data-msg="请输入产品名称"
                                                                placeholder="楼顶扇" id="productsName"
                                                                style="width: 200px;">
                                                            <option value=rf>楼顶扇</option>
                                                        </select>
                                                        <div class="invalid-feedback">
                                                            请输入产品名称
                                                        </div>
