var Datepicker;
!function (t, e, s) {
    var i, a, n, h = "datepicker", o = ".datepicker-here", r = !1,
    ...
    Datepicker = function (t, a) {
        ...
        viewIndexes: ["days", "months", "years"], init: function () {
            ...
            var t, e = this, s = this.loc.dateFormat, i = this.opts.altFieldDateFormat,
                a = this.selectedDates.map(function (t) {
            ...
            var s = t.getTime(), i = n.getParsedDate(t), a = n.getParsedDate(this.minDate),
                h = n.getParsedDate(this.maxDate), o = new Date(i.year, i.month, a.date).getTime(),
                r = new Date(i.year, i.month, h.date).getTime(), c = {
            ...
            var e = this.parsedDate, i = t.data("year") || e.year, a = t.data("month") == s ? e.month : t.data("month"),
                n = t.data("date") || 1;
            ...
            var e, s, i = this._getDimensions(this.$el), a = this._getDimensions(this.$datepicker), n = t.split(" "),
            ...
            var e, s, i, a = n.getParsedDate(this._getFocusedDate()), h = this.opts, o = !1, r = !1, c = !1, d = a.year,
                l = a.month, u = a.date;
            switch (t) {
                case"ctrlRight":
                case"ctrlUp":
    ...
    e.Body = function (t, e, s) {
        ...
        init: function () {
            ...
            var i = "datepicker--cell datepicker--cell-" + s, a = new Date, n = this.d, h = n.opts,
                o = e.getParsedDate(t), r = {}, c = o.date;
            ...
            var s = e.getDaysCount(t), i = new Date(t.getFullYear(), t.getMonth(), 1).getDay(),
                a = new Date(t.getFullYear(), t.getMonth(), s).getDay(), n = i - this.d.loc.firstDay,
    ...
    var t = '<div class="datepicker--nav-action" data-action="prev">#{prevHtml}</div><div class="datepicker--nav-title">#{title}</div><div class="datepicker--nav-action" data-action="next">#{nextHtml}</div>',
        e = '<div class="datepicker--buttons"></div>',
